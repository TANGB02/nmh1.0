 ...
 * @LastEditTime: 2023-12-24 01:13:02
...
<template>
  ...
  >
    <a-form-item name="userName" label="人员名称">
      <a-input style="width: 260px" v-model:value="searchData.userName" />
    </a-form-item>
    <a-form-item name="userPhone" label="手机号">
      <a-input style="width: 260px" v-model:value="searchData.userPhone" />
    </a-form-item>
    <a-form-item name="userStates" label="状态">
      <a-select
